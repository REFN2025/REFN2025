...
# 3. 基础路径配置
BASE_CASEPATH = os.path.normpath(r'C:\Users\Administrator.DESKTOP-A9R1SCS\Desktop\GRPOTEST1\code\data\testcase')
RULEID = '1234567'
IS_ALERT = 1
NO_ALERT = 0
...
def fuzz_rule(original_rule, attack_type):
    ...
    order_preserved_fields = {
        ...
        # ...新增配置...
        "bladabindi": ["filename", "content"],
        "ciscoroutercmp": ["CMP", "content"],
        "conficker": ["MS08067", "content"],
        "gh0strat": ["shellcode", "content"],
        "pony": ["POST", "login.php"],
        "trojanvalyria": ["xor_key", "content"],
        "virut": ["MZ_header", "content"],
        "yakesmalware": ["RSA_key", "content"],
        "locky": ["js_header", "content"]
    }
